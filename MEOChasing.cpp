...
uint32_t MEOChasing::Do()
{
    ...
    {
    case 0:
        g35_.fill_sequence(0, count_, sequence_, 1, MEOG35::MAX_INTENSITY, GreenAccentedAlalogic);
        break;
    case 1:
        g35_.fill_sequence(0, count_, sequence_, 1, MEOG35::MAX_INTENSITY, RedAccentedAlalogic);
        break;
    case 2:
        g35_.fill_sequence(0, count_, sequence_, 1, MEOG35::MAX_INTENSITY, BlueAccentedAlalogic);
        break;
    case 3:
        g35_.fill_sequence(0, count_, sequence_, 1, MEOG35::MAX_INTENSITY, PurplyBlue);
        break;
    case 4:
        g35_.fill_sequence(0, count_, sequence_, 1, MEOG35::MAX_INTENSITY, Valentines);
        break;
    case 5:
        g35_.fill_sequence(0, count_, sequence_, 1, MEOG35::MAX_INTENSITY, BlueTriad);
        break;
    case 6:
        g35_.fill_sequence(0, count_, sequence_, 1, MEOG35::MAX_INTENSITY, BlueTetrad);
        break;
    case 7:
        g35_.fill_sequence(0, count_, sequence_, 1, MEOG35::MAX_INTENSITY, PurpleTetrad);
        break;
    case 8:
        g35_.fill_sequence(0, count_, sequence_, 1, MEOG35::MAX_INTENSITY, GreenTetrad);
        break;
    case 9:
    ...
    case 22:
        ...
        break;
    case 23:
        g35_.fill_sequence(0, count_, sequence_, 2, MEOG35::MAX_INTENSITY, PastelRGB);
        break;
    }
